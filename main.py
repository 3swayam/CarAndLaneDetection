...
from LaneDetectionV2 import process_road_detection
...
# road_highlighted=process_road_detection(car_detected_image)
...
while (cap.isOpened()):
    ...
    lane_detected_image = process_road_detection(car_detetced_image)
